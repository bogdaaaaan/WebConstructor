...
import useStyle from './style/PView';

const BuilderP = DnDBuilderHOC(Resizable(P));
const BuilderPInput = DnDBuilderHOC(Resizable(PInput));
...
const PPreview = ({
    ...
    const BuilderPComponent = (
        !editing 
        ? BuilderP 
        : BuilderPInput
    );
    return <BuilderPComponent
        // DnD Props
